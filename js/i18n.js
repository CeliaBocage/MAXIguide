...
const I18N = (() => {
  ...
  const STRINGS = {
    fr: {
      ...
      'carte.zoomHint': 'Zoomez (pincez à deux doigts, + / − ou double-clic) pour faire apparaître tous les noms, puis glissez pour vous promener.',
    ...
    en: {
      ...
      'carte.zoomHint': 'Zoom in (pinch with two fingers, + / − or double-click) to reveal every name, then drag to wander around.',
