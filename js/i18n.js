...
const I18N = (() => {
  ...
  const STRINGS = {
    fr: {
      ...
      'carte.legendRated': 'Domaine noté — la couleur teinte aussi les vignes autour',
      'carte.legendRiver': 'Rivière',
      'carte.legendVillage': 'Village',
      'carte.legendVines': 'Vignes',
    ...
    en: {
      ...
      'carte.legendRated': 'Rated winery — the colour also tints the vines around it',
      'carte.legendRiver': 'River',
      'carte.legendVillage': 'Village',
      'carte.legendVines': 'Vines',
