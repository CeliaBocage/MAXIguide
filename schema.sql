...
--   ALTER TABLE ratings RENAME COLUMN note_whisky TO note_liqueur;
--   ALTER TABLE ratings ADD COLUMN note_methode INTEGER CHECK (note_methode BETWEEN 1 AND 5);

-- Une fiche de notation par utilisateur et par domaine :
--   notes séparées blancs / rouges / rosés / méthode ancestrale / liqueurs /
--   jus de raisin (1 à 5, NULL si pas goûté),
...
CREATE TABLE IF NOT EXISTS ratings (
  ...
  note_methode INTEGER CHECK (note_methode BETWEEN 1 AND 5),
  note_liqueur INTEGER CHECK (note_liqueur BETWEEN 1 AND 5),
